...
int main(void) 
{
  ...
  host_addr.sin_family = AF_INET;  // Haremos uso de direcciones de IP V4
  host_addr.sin_port = htons(PORT);	 // Asignamos el numero de puerto a usar
  ...
  while(1) {    // Accept loop
	...
	{
	  printf("Finalizando conexion con el cliente ...");
	  break;
	}
      printf("ENV: ");
      scanf("%s", buffer);
